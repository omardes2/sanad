 ...
 */
it('is the 60th of 64 migrations, creates tool_consents with its identity and index, and rolls back and forward cleanly', function () {
    $files = glob(database_path('migrations/*.php'));

    expect($files)->toHaveCount(64)
        ->and(basename($files[count($files) - 5]))->toBe('2026_09_07_000101_create_tool_consents_table.php')
