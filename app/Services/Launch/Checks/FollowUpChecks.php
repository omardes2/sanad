...
final class FollowUpChecks
{
    public static function followUp(): GateOutcome
    {
        ...
        $details = [
            ...
            GateDetail::plain(
                'ميزانية الأسئلة',
                'من حقيقة التسليم وحدها: السؤال الذي بلغ «أُرسل» (status = sent). المطالبة لا تستهلك، والمحاولة المُؤذَن بها لا تستهلك، والمرفوض قبل الإرسال لا يستهلك، والعامل الذي مات قبل الشبكة لا يستهلك',
            ),
            GateDetail::plain(
                'النتيجة غير المعروفة',
                'لا تُقرأ «أُرسل» ولا «لم يُرسَل»: الحلقة تُحجَز موقوفة تشغيليًا بلا استهلاك ميزانية وبلا سؤال بديل، والاستعادة قرار إنسان',
            ),
            GateDetail::plain(
                'الإغلاق',
