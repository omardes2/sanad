...
- **لا عمود `asks_sent`**: ميزانية الأسئلة **مشتَقّة من حقيقة التذكير** — عدد صفوف الأسئلة التي `attempts > 0`، أي غادرت المنصّة فعلًا. فالسؤال المرفوض **قبل** الإرسال (بلا قالب معتمَد) لا يستهلك شيئًا بنيويًّا، ولا يوجد عدّاد ينحرف عمّا يَعُدّه (ADR-0052).
