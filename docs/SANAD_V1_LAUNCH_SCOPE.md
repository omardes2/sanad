...
| **Voice Notes / التفريغ الصوتي** | نطاق V1 يشترط أن يرسل المستخدم رسالة صوتية ويحصل على فهم ورد. **منفَّذ** الآن، فالبند صار **يُبلِّغ** بدل أن يُعلن غيابًا: يُقرأ من `voice.enabled` + إمكان تنزيل وسائط واتساب + وجود نموذج تفريغ **مفهرَس وقابل للتوجيه** لمزوّد ينفّذ `SupportsTranscription`. بلا نموذج مفهرَس **لا يوجد مسار تفريغ إطلاقًا** — والرسالة الصوتية تُخزَّن ويُردّ عليها بسبب محدود، ولا يُخمَّن نموذج. الضمان **مرّة على الأقل بحدّ أعلى محاولتين فعليتين**، لا exactly-once؛ وصفوف الاستخدام تُسجَّل **بلا سعر** (ADR-0047، ADR-0048). | تشغيلي: فهرسة نموذج تفريغ |
