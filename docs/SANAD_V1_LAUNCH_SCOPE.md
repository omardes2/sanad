...
| **Durable personal memory** | ذاكرة V1 إلزامية، لكنها تحتاج سياسة صلة وتخزينًا محدودًا ودلالات تحديث وحذف/نسيان وقواعد مِلكية وخصوصية — فلها مرحلتها الخاصة، ولا تُنفَّذ كأداة كتابة عابرة. | مرحلة الذاكرة |
