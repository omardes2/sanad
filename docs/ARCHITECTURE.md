...
- **بعد Phase E — فعلي بعد التسوية:** `Reconciled Cash Contribution`؛ `Reconciled Gross Profit / Margin` يبقى `NOT AVAILABLE` حتى تُقرَّر سياسة Revenue Recognition.
