...
- **الذاكرة الدائمة**: الحفظ **والنسيان** بطلب صريح فقط في V1، والنية الصريحة سلطة مستقلة عن الموافقة تُقرأ من رسالة المشترك الواردة نفسها (والتصحيح ليس إذنًا بالمحو)؛ والبصمة مقيَّدة بالمالك والصنف بترميز مسبوق بالأطوال فلا تكشف تطابق ذاكرة بين مشتركَين؛ وإعادة محاولة الطابور تعيد اشتقاق قراءة الذاكرة بدل أن تفقد جوابها؛ المحتوى مشفَّر بمفتاح مستقل والبصمة HMAC بمفتاح مستقل ثانٍ، وبلا مفتاح **لا ذاكرة إطلاقًا** (النص العادي ليس بديلًا)؛ التطبيع متحفّظ لا يطوي حروفًا عربية؛ عند الامتلاء تُرفض الجديدة ولا يُطرد شيء؛ والحقن في الـprompt محدود ومسيَّج ومشروط بموافقة حيّة.
