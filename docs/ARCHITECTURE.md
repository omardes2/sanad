...
- **بعد Phase E — فعلي بعد التسوية:** `Actual Provider Cost`، `Reconciled Cost`، `Reconciled Cash Contribution`؛ `Reconciled Gross Profit / Margin` يبقى `NOT AVAILABLE` حتى تُقرَّر سياسة Revenue Recognition.
