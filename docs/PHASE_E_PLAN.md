...
- **التدقيق**: audit الخدمات فقط (لا audit إضافي من الواجهة، لا double audit؛ الرفض/stale لا يترك audit مالي ناجح)؛ روابط read-only إلى صفحة التدقيق بـ`subject_type=CustomerPayment` عند `audit.view`.
